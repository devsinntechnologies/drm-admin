...
export const PRINTER_CONNECTION_TYPES = ["ethernet", "wifi"] as const;
...
export function printerStatusLabel(printer: Pick<BusinessPrinter, "lastStatus" | "ip" | "ipMode">): string {
