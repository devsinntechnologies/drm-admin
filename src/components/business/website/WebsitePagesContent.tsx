...
export function WebsitePagesContent({ businessId }: { businessId?: string } = {}) {
  const { website, loading, listPages, createPage, updatePage, deletePage } = useWebsite(businessId);
